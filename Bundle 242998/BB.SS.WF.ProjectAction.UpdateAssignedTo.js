    ...
    function (record, search, runtime, file) {
        ...
        function onAction(scriptContext) {
            try {
                ...
                var updateaction = runtime.getCurrentScript().getParameter({ name: 'custscript_wfa_uat_package_action' });
                var updatestatus = runtime.getCurrentScript().getParameter({ name: 'custscript_wfa_uat_field_value' });
                ...
                var actionsearch = search.load({
                    id: 'customsearch_bb_wfa_updateassignedto'
                });
                ...
                expr.push('AND', ["custrecord_bb_proj_act_assigned_to_emp", "noneof", updatestatus]);
                ...
                actionsearch.run().each(function (result) {
                    ...
                    var test = record.submitFields({
                        ...
                        id: actionid,
                        values: {
                            'custrecord_bb_proj_act_assigned_to_emp': updatestatus
                        },
                        options: {
