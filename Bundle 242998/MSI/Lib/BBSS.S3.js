 ...
 */
define(['./crypto-js', './bb_framework_all', 'N/encode', 'N/https','N/runtime','N/search','N/record','N/file','N/http','N/ui/serverWidget'],
	function(CryptoJS, framework, encode, https, runtime, search, record, file,http,ui) {
...
BB.S3.Service.prototype.loadCredentials = function() {
	...
	//this._bucket = 'ns-'+accountId.replace('_','-');
...
BB.S3.Service.prototype.callAmazonWithHeaders = function(getHostMethod, method, additionalHeaders, name, data, contentType, acl, error, success) {
	...
	log.debug('s3 service name',name);
 ...
 */
BB.S3.Service.prototype.getPresignedUrl = function(name, expirationSeconds) {
 ...
 * @returns {string} The presigned URL.
 */
BB.S3.Service.prototype.getPresignedListUrl = function(prefix, expirationSeconds) {
...
BB.S3.Service.prototype.copyObject = function(CopySource, newName) {
...
BB.S3.ImageViewer.prototype.generateView = function () {
	...
	// require(['N/ui/serverWidget'], function (ui) {
		...
		field.defaultValue = '<img src="' + imageUrl + '"/>';
...
BB.S3.PdfViewer.prototype.generateView = function () {
	...
	// require(['N/ui/serverWidget'], function (ui) {
		...
		field.defaultValue = ['<object ', objectProperties, '>', fallback, '</object>'].join('');
