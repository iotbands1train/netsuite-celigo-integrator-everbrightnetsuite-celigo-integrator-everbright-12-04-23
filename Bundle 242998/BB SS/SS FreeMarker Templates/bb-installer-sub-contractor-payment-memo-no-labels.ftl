...
<table id="payment-memo" class="payment-memo"><tbody>
    ...
    <#if project.custentity_bb_installer_price_p_w.value?number!=0>
    <tr>
        <td>Price / Watt</td>
        <td></td>
        <td></td>
    ...
    <#if project.installFixedAdders?size != 0 || project.installPerWattAdders?size != 0 || project.intallPerFootAdders?size != 0 || project.installPerModAdders?size != 0 >
        <!-- header & first row -->
        <@header/>
    </#if>
    ...
    <#list project.intallPerFootAdders as adder>
        <#if adder_has_next>
            <tr>
                <@cells adderItem=adder/>
            </tr>
    ...
    <#if project.custentity_bb_installer_m1_vbill_amt.value?number!=0>
    <tr>
        <td>M1</td>
        <td></td>
        <td></td>
    ...
    <#if project.custentity_bb_installer_m2_vbill_amt.value?number!=0>
    <tr>
        <td>M2</td>
        <td></td>
        <td></td>
    ...
    <#if project.custentity_bb_installer_m3_vbill_amt.value?number!=0>
    <tr>
        <td>M3</td>
        <td></td>
        <td></td>
    ...
    <#if project.custentity_bb_installer_m4_vbill_amt.value?number!=0>
    <tr>
        <td>M4</td>
        <td></td>
        <td></td>
    ...
    <#if project.custentity_bb_installer_m5_vbill_amt.value?number!=0>
    <tr>
        <td>M5</td>
        <td></td>
        <td></td>
    ...
    <#if project.custentity_bb_installer_m6_vbill_amt.value?number!=0>
    <tr>
        <td>M6</td>
        <td></td>
        <td></td>
    ...
    <#if project.custentity_bb_installer_m7_vbill_amt.value?number!=0>
    <tr>
        <td>M7</td>
        <td></td>
        <td></td>
    ...
    <#if project.custentity_bb_installer_vbill_ttl_amt.value?number!=0>
    <tr class="bb-total">
        <td>Total Paid</td>
        <td></td>
        <td></td>
