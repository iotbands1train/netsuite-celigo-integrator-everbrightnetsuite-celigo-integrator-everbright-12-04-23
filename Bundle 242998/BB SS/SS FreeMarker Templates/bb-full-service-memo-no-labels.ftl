...
<table id="payment-memo" class="payment-memo"><tbody>
    ...
    <#if project.custentity_bb_fin_owned_equip_costs_amt.value?number!=0>
    <tr>
        <td>Financier Owned Equipment Costs</td>
        <td></td>
        <td></td>
    ...
    <#if project.custentity_bb_fin_base_fees_amount.value?number!=0>
    <tr>
        <td>Financier Base Fees</td>
        <td></td>
        <td></td>
        <td class="bb-currency">${project.custentity_bb_fin_base_fees_amount.value?number?string.currency}</td>
    </tr>
    </#if>
    <#if project.custentity_bb_fin_monitoring_fee_amount.value?number!=0>
    <tr>
        <td>Financier Monitoring Amount</td>
        <td></td>
        <td></td>
        <td class="bb-currency">${project.custentity_bb_fin_monitoring_fee_amount.value?number?string.currency}</td>
    </tr>
    </#if>
    <#if project.custentity_bb_fin_total_fees_amount.value?number!=0>
    <tr class="bb-total">
        <td>Financier Total Fees</td>
        <td></td>
        <td></td>
    ...
    <#if project.custentity_bb_fin_total_invoice_amount.value?number!=0>
    <tr class="bb-total">
        <td>Financier Total Invoice Amount</td>
        <td></td>
        <td></td>
