    ...
    function(record, search, serverWidget, task, redirect, runtime, url, config) {
        ...
        function onRequest(context) {
            if (context.request.method == 'GET') {
                ...
                var formTitle = runtime.getCurrentScript().getParameter({name: 'custscript_bb_part_pc_title'}) || 'Partner Phone Calls';
                ...
                form.addButton({
                    id: 'custpage_search_phone_calls',
                    label: 'Search PhoneCalls',
                    functionName: 'searchPhoneCalls()'
                });
        ...
        function setSublistValues(sublist, sDate, eDate, assignedTo, status) {
            ...
            var searchId = runtime.getCurrentScript().getParameter({name: 'custscript_bb_all_phone_search'});
            if (searchId) {
