...
define(['./../Helpers', './AuthenticationStatus', './DocumentVisibility', './ErrorDetails', './IdCheckInformationInput', './RecipientAttachment', './RecipientEmailNotification'
        , './RecipientPhoneAuthentication', './RecipientSAMLAuthentication', './RecipientSMSAuthentication', './SocialAuthentication', './UserInfo'],
    function (helpersModule, authenticationStatusModel, documentVisibilityModel, errorDetailsModel, idCheckInformationInputModel, recipientAttachmentModel, recipientEmailNotificationModel
        , recipientPhoneAuthenticationModel, recipientSAMLAuthenticationModel, recipientSMSAuthenticationModel, socialAuthenticationModel, userInfoModel) {
        /**
        ...
        /**
         * Constructs a new <code>CertifiedDelivery</code>.
         * @alias module:model/CertifiedDelivery
         * @class
         */
        ...
        /**
         * Constructs a <code>CertifiedDelivery</code> from a plain JavaScript object, optionally creating a new instance.
         * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
         * @param {Object} data The plain JavaScript object bearing properties of interest.
         * @param {module:model/CertifiedDelivery} obj Optional instance to populate.
         * @return {module:model/CertifiedDelivery} The populated <code>CertifiedDelivery</code> instance.
         */
