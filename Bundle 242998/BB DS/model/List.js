...
define(['./../Helpers', './ErrorDetails', './ListItem', './MergeField'], function (helpersModule, errorDetailsModel, listItemModel, mergeFieldModel) {
    /**
    ...
    _exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('listItems')) {
                obj['listItems'] = helpersModule.convertToType(data['listItems'], [listItemModel]);
            }
