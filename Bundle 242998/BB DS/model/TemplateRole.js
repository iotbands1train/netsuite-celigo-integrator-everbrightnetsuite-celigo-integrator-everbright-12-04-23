...
define(['./../Helpers', './RecipientEmailNotification', './RecipientSignatureProvider', './Tabs'],
    function (helpersModule, recipientEmailNotificationModel, recipientSignatureProviderModel, tabsModel) {
    /**
    ...
    _exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('inPersonSignerName')) {
                obj['inPersonSignerName'] = helpersModule.convertToType(data['inPersonSignerName'], 'String');
            }
     ...
     */
    _exports.prototype['inPersonSignerName'] = undefined;
    /**
