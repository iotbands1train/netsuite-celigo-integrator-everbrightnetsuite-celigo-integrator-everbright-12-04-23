...
define(['./../Helpers', './AuthenticationStatus', './DocumentVisibility', './ErrorDetails', './IdCheckInformationInput', './RecipientAttachment', './RecipientEmailNotification'
        , './RecipientPhoneAuthentication', './RecipientSAMLAuthentication', './RecipientSMSAuthentication', './SocialAuthentication', './Tabs'],
    function (helpersModule, authenticationStatusModel, documentVisibilityModel, errorDetailsModel, idCheckInformationInputModel, recipientAttachmentModel, recipientEmailNotificationModel
              , recipientPhoneAuthenticationModel, recipientSAMLAuthenticationModel, recipientSMSAuthenticationModel, socialAuthenticationModel, tabsModel) {
        /**
        ...
        _exports.constructFromObject = function (data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('hostRecipientId')) {
                    obj['hostRecipientId'] = helpersModule.convertToType(data['hostRecipientId'], 'String');
                }
         ...
         */
        _exports.prototype['hostRecipientId'] = undefined;
        /**
