...
define(['./../Helpers', './ErrorDetails', './MergeField', './PaymentDetails'], function (helpersModule, errorDetailsModel, mergeFieldModel, paymentDetailsModel) {
  /**
  ...
  /**
   * Constructs a new <code>FormulaTab</code>.
   * @alias module:model/FormulaTab
   * @class
   */
  ...
  /**
   * Constructs a <code>FormulaTab</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FormulaTab} obj Optional instance to populate.
   * @return {module:model/FormulaTab} The populated <code>FormulaTab</code> instance.
   */
  _exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('formula')) {
        obj['formula'] = helpersModule.convertToType(data['formula'], 'String');
      }
      if (data.hasOwnProperty('hidden')) {
        obj['hidden'] = helpersModule.convertToType(data['hidden'], 'String');
      }
      if (data.hasOwnProperty('isPaymentAmount')) {
        obj['isPaymentAmount'] = helpersModule.convertToType(data['isPaymentAmount'], 'String');
      }
      ...
      if (data.hasOwnProperty('paymentDetails')) {
        obj['paymentDetails'] = paymentDetailsModel.constructFromObject(data['paymentDetails']);
      }
      ...
      if (data.hasOwnProperty('roundDecimalPlaces')) {
        obj['roundDecimalPlaces'] = helpersModule.convertToType(data['roundDecimalPlaces'], 'String');
      }
   ...
   */
  _exports.prototype['formula'] = undefined;
  /**
   * 
   * @member {String} hidden
   */
  _exports.prototype['hidden'] = undefined;
  /**
   ...
   */
  _exports.prototype['isPaymentAmount'] = undefined;
  /**
   ...
   */
  _exports.prototype['paymentDetails'] = undefined;
  /**
  ...
  /**
   * 
   * @member {String} roundDecimalPlaces
   */
  _exports.prototype['roundDecimalPlaces'] = undefined;
  /**
