...
define(['./../Helpers'], function (helpersModule) {
    ...
    _exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('emailBody')) {
                obj['emailBody'] = helpersModule.convertToType(data['emailBody'], 'String');
            }
            ...
            if (data.hasOwnProperty('supportedLanguage')) {
                obj['supportedLanguage'] = helpersModule.convertToType(data['supportedLanguage'], 'String');
            }
        }
        return obj;
    };
     ...
     */
    _exports.prototype['emailBody'] = undefined;
    /**
     ...
     */
    _exports.prototype['supportedLanguage'] = undefined;
