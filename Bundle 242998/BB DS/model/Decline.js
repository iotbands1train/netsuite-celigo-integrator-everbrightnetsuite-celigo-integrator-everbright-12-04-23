...
define(['./../Helpers', './ErrorDetails', './MergeField'], function (helpersModule, errorDetailsModel, mergeFieldModel) {
    ...
    _exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('buttonText')) {
                obj['buttonText'] = helpersModule.convertToType(data['buttonText'], 'String');
            }
            ...
            if (data.hasOwnProperty('declineReason')) {
                obj['declineReason'] = helpersModule.convertToType(data['declineReason'], 'String');
            }
     ...
     */
    _exports.prototype['buttonText'] = undefined;
    /**
     ...
     */
    _exports.prototype['declineReason'] = undefined;
    /**
