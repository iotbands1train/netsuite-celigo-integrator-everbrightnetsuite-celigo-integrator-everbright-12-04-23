...
define(['./../Helpers', './ErrorDetails', './MergeField'], function (helpersModule, errorDetailsModel, mergeFieldModel) {
    ...
    _exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('useDash4')) {
                obj['useDash4'] = helpersModule.convertToType(data['useDash4'], 'String');
            }
    ...
    /**
     *
     * @member {String} useDash4
     */
    _exports.prototype['useDash4'] = undefined;
    /**
