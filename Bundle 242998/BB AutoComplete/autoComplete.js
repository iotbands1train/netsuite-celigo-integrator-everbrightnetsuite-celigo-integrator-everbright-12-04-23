...
this.window && (function (global, factory) {
  ...
  var addResultsToList = function addResultsToList(resultsList, dataSrc, resultItem) {
    // console.log('addResultsToList',resultsList,dataSrc,resultItem);
  ...
  function () {
    ...
    _createClass(autoComplete, [{
      ...
      value: function search(query, record) {
        var recordLowerCase = String(record).toLowerCase();
        // console.log(this.searchEngine,'recordLowerCase',recordLowerCase,query);
        if (this.searchEngine === "loose") {
          // console.log('searchEngine loose');
