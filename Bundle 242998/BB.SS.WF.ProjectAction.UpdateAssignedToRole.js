    ...
    function (record, search, runtime, file) {
        ...
        function onAction(scriptContext) {
            try {
                ...
                var updateaction = runtime.getCurrentScript().getParameter({ name: 'custscript_wfa_uatr_package_action' });
                var updatestatus = runtime.getCurrentScript().getParameter({ name: 'custscript_wfa_uatr_field_value' });
                ...
                var actionsearch = search.load({
                    id: 'customsearch_bb_wfa_updateassignedrole'
                });
                ...
                expr.push('AND', ["custrecord_bb_proj_act_assigned_role", "noneof", updatestatus]);
                ...
                actionsearch.run().each(function (result) {
                    ...
                    var test = record.submitFields({
                        ...
                        id: actionid,
                        values: {
                            'custrecord_bb_proj_act_assigned_role': updatestatus
                        },
                        options: {
